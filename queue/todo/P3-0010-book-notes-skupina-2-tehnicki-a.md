# Teaching notes: skupina II — tehnički (prva polovica)

prio:       P3
cluster:    book-notes-s2-tehnicki
files:      quiz/build/work/packet_book_s2_tehnicki_a.json, quiz/build/notes_book_s2_tehnicki_a.json
blocked-by: 0005
...
**Done when.** All 30 have a note in `notes_book_s2_tehnicki_a.json`, every citation
