# Teaching notes: skupina VI — pravila i postupci

prio:       P3
cluster:    book-notes-s6-pravila
files:      quiz/build/work/packet_book_s6_pravila.json, quiz/build/notes_book_s6_pravila.json
blocked-by: 0005

**Why.** 40 of the 720 book questions from SKUPINA VI. They are answerable and cited
to the priručnik's own key table, but carry no teaching note — the last large body of work
on the corpus.

**Done when.** All 40 have a note in `notes_book_s6_pravila.json`, every citation
