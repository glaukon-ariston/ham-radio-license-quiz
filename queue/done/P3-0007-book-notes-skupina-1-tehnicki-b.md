# Teaching notes: skupina I — tehnički (druga polovica)

prio:       P3
cluster:    book-notes-s1-tehnicki
files:      quiz/build/work/packet_book_s1_tehnicki_b.json, quiz/build/notes_book_s1_tehnicki_b.json
blocked-by: 0005

**Why.** 30 of the 720 book questions from SKUPINA I. They are answerable and cited
to the priručnik's own key table, but carry no teaching note — the last large body of work
on the corpus.

**Done when.** All 30 have a note in `notes_book_s1_tehnicki_b.json`, every citation
