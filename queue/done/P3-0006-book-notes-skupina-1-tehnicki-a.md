# Teaching notes: skupina I — tehnički (prva polovica)

prio:       P3
cluster:    book-notes-s1-tehnicki
files:      quiz/build/work/packet_book_s1_tehnicki_a.json, quiz/build/notes_book_s1_tehnicki_a.json
blocked-by: 0005
...
**Done when.** All 30 have a note in `notes_book_s1_tehnicki_a.json`, every citation
